...
export function ThemesScreen() {
  ...
  if (state.status === "unavailable")
    return <View style={{ flex: 1, backgroundColor: c.bg }}><EmptyState title="Themes couldn't load" body="Check your connection and try again." actionLabel="Try again" onAction={state.reload} /></View>;
