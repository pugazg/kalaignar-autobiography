      ...
      <header className="border-b border-ink/10 bg-mist/40 dark:border-white/10 dark:bg-night-surface/40">
        <div className="mx-auto max-w-3xl px-5 py-12 sm:px-6">
          ...
          <p className="mt-3 max-w-xl rounded-xl border border-marina/25 bg-marina/[0.05] px-4 py-2.5 text-sm text-ink/70 dark:bg-marina/10 dark:text-night-text/70">
            {ta
              ? "54 தொகுதிகளில் தொகுதி 51 முதல் 54 வரை (2014–2016) முதற்கனிகளாக வாசிக்கக் கிடைக்கின்றன — தொகுதி 51, 52 மற்றும் 53, தமிழ் மூலத்துடன் முழு ஆங்கில மொழிபெயர்ப்பும் கொண்டவை. எஞ்சிய தொகுதிகள் ஒவ்வொன்றாக வந்து சேரும்."
              : "Volumes 51 to 54 (2014–2016) are the first of the fifty-four to arrive — Volumes 51, 52 and 53 each with a full English translation alongside the authoritative Tamil. The rest are on their way, each joining as its text and corrections are completed."}
          </p>
          {idx && (
