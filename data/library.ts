...
// Shared present-rights record reused by the Wave-7 Batches 2-4 Kalaignar-authored works whose
// nationalisation is on the model — the 2 dramas and 5 novels. Substantively identical to the records
// already on manohara / kagithapoo / pudhaiyal. It is DELIBERATELY not applied to the 6 Wave-7 B4 essays:
// exactly like the existing essay entries (ina-muzhakkam, kolaikkalam, …), no essay is given `rights` here,
// because rights are added only on evidence, never merely because sibling works carry them.
const RIGHTS_NATIONALISED: WorkRights = {
...
const CATALOGUE_RECORDS: LibraryWork[] = [
  ...
  },
  {
    ...
    state: "published",
    descTa: "மூலத்தில் அமைந்த ஐந்து பிரிவுகளாக 77 கவிதைகள்",
    descEn: "77 poems arranged in five source-established groups",
    sourceRepo: "pugazg/kalaignar-poems",
  ...
  // ── WAVE 6 P4 — Batches 1–6 published (22 works) ─────────────────────────────────────────────────
  // These 22 works were merged through Wave-6 P1–P3 as DIRECT reader routes only; P4 now exposes those
  // already-existing routes through the catalogue, /read discovery and the sitemap. P4 creates ZERO new
  // routes. Every field below is derived from each work's merged, frozen P1–P3 payload/provenance;
  // rights are set only where that provenance establishes them (the five essays record none).
  {
    id: "ammaiyappan",
    slug: "ammaiyappan",
    titleTa: "அம்மையப்பன்",
    ...
    readerStructure: "scene",
    href: "/cinema/ammaiyappan",
    state: "published",
    descTa: "திரைக்கதை / வசன நூல்: 63 களஞ்சிய வழிசெலுத்தல் காட்சிப் பகுதிகள் (மூல எண்ணிடப்பட்ட காட்சிகள் அல்ல)",
    descEn: "Screenplay-dialogue booklet: 63 archival navigation scene segments (not source-numbered scenes)",
    sourceRepo: "pugazg/kalaignar-cinema-works",
    ...
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 63, labelTa: "களஞ்சியப் பகுதிகள்", labelEn: "archive scene segments" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
    ...
    provenanceHref: "/cinema/ammaiyappan/source",
  },
  {
    id: "kagithapoo",
    slug: "kagithapoo",
    ...
    subtype: "stage-play",
    readerStructure: "stage-play",
    href: "/plays/kagithapoo",
    state: "published",
    descTa: "மேடை நாடகம்: மூலத்தில் தெரியும் காட்சியமைப்பு (எண்ணிடப்பட்ட காட்சிகளுக்கு இடையே எண்ணிடப்படாத ஒரு காட்சியுடன்)",
    descEn: "Stage play with the source-visible scene structure (an unnumbered காட்சி between the numbered scenes)",
    sourceRepo: "pugazg/kalaignar-stage-plays",
    sourcePath: "works/kagithapoo",
    sourceCommit: "61c0f410fd24b1419779532a4a1b049cdff10bf7",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 23, labelTa: "காட்சிகள்", labelEn: "scenes" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
    ...
    provenanceHref: "/plays/kagithapoo/source",
  },
  {
    id: "manimagudam",
    slug: "manimagudam",
    ...
    subtype: "stage-play",
    readerStructure: "stage-play",
    href: "/plays/manimagudam",
    state: "published",
    descTa: "மேடை நாடகம்",
    descEn: "Stage play",
    sourceRepo: "pugazg/kalaignar-stage-plays",
    sourcePath: "works/manimagudam",
    sourceCommit: "61c0f410fd24b1419779532a4a1b049cdff10bf7",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 47, labelTa: "காட்சிகள்", labelEn: "scenes" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
    ...
    provenanceHref: "/plays/manimagudam/source",
  },
  {
    id: "thiruvalar-desiyampillai",
    slug: "thiruvalar-desiyampillai",
    titleTa: "திருவாளர் தேசீயம்பிள்ளை",
    titleEn: "Thiruvalar Desiyampillai",
    shelf: "drama",
    subtype: "stage-play",
    readerStructure: "stage-play",
    href: "/plays/thiruvalar-desiyampillai",
    state: "published",
    descTa: "மேடை நாடகம்: மூலம் எண்ணிடப்பட்ட அங்க/காட்சி முறையை நிறுவவில்லை; ஏழு மூல-நம்பகமான வாசிப்புப் பகுதிகள் (மூல நிலைத் தகுதிப்பாட்டுடன்)",
    descEn: "Stage play; the source establishes no numbered act/scene system — seven source-faithful reading units, with its documented source-condition qualification",
    sourceRepo: "pugazg/kalaignar-stage-plays",
    sourcePath: "works/thiruvalar-desiyampillai",
    sourceCommit: "61c0f410fd24b1419779532a4a1b049cdff10bf7",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 7, labelTa: "வாசிப்புப் பகுதிகள்", labelEn: "reading units" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
    ...
    provenanceHref: "/plays/thiruvalar-desiyampillai/source",
  },
  {
    id: "idhaya-perikai",
    slug: "idhaya-perikai",
    titleTa: "இதய பேரிகை",
    titleEn: "Idhaya Perikai",
    shelf: "speeches",
    subtype: "public-speech",
    readerStructure: "speech",
    href: "/speeches/idhaya-perikai",
    state: "published",
    descTa: "பல பகுதிகள் கொண்ட அச்சிட்ட நூல்; ஒரே தேதி/இடம் நிறுவப்படவில்லை",
    descEn: "A multi-section printed booklet; no single date or venue is established",
    sourceRepo: "pugazg/kalaignar-public-speeches",
    sourcePath: "speeches/idhaya-perikai",
    sourceCommit: "b7b0933cdd68c3fea6f237a4c63fd9a100efc74f",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    rights: {
    ...
    provenanceHref: "/speeches/idhaya-perikai/source",
  },
  {
    id: "namathu-nilai",
    slug: "namathu-nilai",
    titleTa: "நமது நிலை",
    titleEn: "Our Position",
    shelf: "speeches",
    subtype: "assembly-speech",
    readerStructure: "speech",
    href: "/speeches/namathu-nilai",
    state: "published",
    descTa: "தொகுக்கப்பட்ட இரு-அவை சான்று; ஒற்றைத் தேதியிட்ட சட்டமன்றப் படியெடுப்பு அல்ல (date: null)",
    descEn: "An edited two-House witness; not one dated Assembly transcript (date: null)",
    sourceRepo: "pugazg/kalaignar-assembly-speeches",
    sourcePath: "speeches/1971/1971-namathu-nilai",
    sourceCommit: "10ccbf4f18b82d078b818892b9c4a745e2eb30d7",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    rights: {
    ...
    provenanceHref: "/speeches/namathu-nilai/source",
  },
  {
    id: "palli-vazhkkai",
    slug: "palli-vazhkkai",
    titleTa: "பள்ளி வாழ்க்கை",
    titleEn: "Palli Vazhkkai",
    shelf: "speeches",
    subtype: "public-speech",
    readerStructure: "speech",
    href: "/speeches/palli-vazhkkai",
    state: "published",
    descTa: "அச்சிட்ட தொகுப்பு; உட்பகுதிகளுக்கு தனித் தேதி/இடம் நிறுவப்படவில்லை",
    descEn: "A printed compilation; no per-component date or venue is established",
    sourceRepo: "pugazg/kalaignar-public-speeches",
    sourcePath: "speeches/palli-vazhkkai",
    sourceCommit: "b7b0933cdd68c3fea6f237a4c63fd9a100efc74f",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    ...
    provenanceHref: "/speeches/palli-vazhkkai/source",
  },
  {
    id: "thalaikettan-thambi",
    slug: "thalaikettan-thambi",
    titleTa: "தலைகேட்டான் தம்பி",
    titleEn: "The Younger Brother Who Asked for a Head",
    shelf: "poetry",
    subtype: "poem",
    readerStructure: "poem",
    href: "/poems/thalaikettan-thambi",
    state: "published",
    descTa: "கலைஞரின் தனிக் கவிதை (1966)",
    descEn: "A standalone poem by Kalaignar (1966)",
    sourceRepo: "pugazg/kalaignar-poems",
    sourcePath: "poems/thalaikettan-thambi",
    ...
    provenanceHref: "/poems/thalaikettan-thambi/source",
  },
  {
    id: "aanthaiyum-arasanum",
    slug: "aanthaiyum-arasanum",
    titleTa: "ஆந்தையும் அரசனும்!",
    titleEn: "Andhai and the King!",
    shelf: "poetry",
    subtype: "poem",
    readerStructure: "poem",
    href: "/poems/aanthaiyum-arasanum",
    state: "published",
    descTa: "கலைஞரின் தனிக் கவிதை (1965)",
    descEn: "A standalone poem by Kalaignar (1965)",
    sourceRepo: "pugazg/kalaignar-poems",
    sourcePath: "poems/aanthaiyum-arasanum",
    sourceCommit: "188d49cd4dcf2c6bbe2e9633841ff402b9959d08",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    ...
    provenanceHref: "/poems/aanthaiyum-arasanum/source",
  },
  {
    id: "poomudi",
    slug: "poomudi",
    titleTa: "பூமுடி",
    titleEn: "Flower Crown",
    shelf: "poetry",
    subtype: "poem",
    readerStructure: "poem",
    href: "/poems/poomudi",
    ...
    provenanceHref: "/poems/poomudi/source",
  },
  {
    id: "anna-kaviyarangam",
    slug: "anna-kaviyarangam",
    titleTa: "அண்ணா கவியரங்கம்",
    titleEn: "Anna Kaviyarangam",
    shelf: "poetry",
    subtype: "poem",
    readerStructure: "poem",
    href: "/poems/anna-kaviyarangam",
    state: "published",
    descTa: "கலைஞரின் தனிக் கவிதை (1968)",
    descEn: "A standalone poem by Kalaignar (1968)",
    sourceRepo: "pugazg/kalaignar-poems",
    sourcePath: "poems/anna-kaviyarangam",
    sourceCommit: "188d49cd4dcf2c6bbe2e9633841ff402b9959d08",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    ...
    provenanceHref: "/poems/anna-kaviyarangam/source",
  },
  {
    id: "gunanayagar-nehru",
    slug: "gunanayagar-nehru",
    titleTa: "குணநாயகர் நேரு",
    titleEn: "Nehru, the Noble Leader",
    shelf: "poetry",
    subtype: "poem",
    readerStructure: "poem",
    href: "/poems/gunanayagar-nehru",
    state: "published",
    descTa: "கலைஞரின் தனிக் கவிதை",
    descEn: "A standalone poem by Kalaignar",
    sourceRepo: "pugazg/kalaignar-poems",
    sourcePath: "poems/gunanayagar-nehru",
    sourceCommit: "188d49cd4dcf2c6bbe2e9633841ff402b9959d08",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    ...
    provenanceHref: "/poems/gunanayagar-nehru/source",
  },
  {
    id: "kanchithan-annan",
    slug: "kanchithan-annan",
    titleTa: "காஞ்சிதான் அண்ணன்",
    titleEn: "Kanchi Is Anna",
    shelf: "poetry",
    subtype: "poem",
    readerStructure: "poem",
    href: "/poems/kanchithan-annan",
    state: "published",
    descTa: "கலைஞரின் தனிக் கவிதை (1970)",
    descEn: "A standalone poem by Kalaignar (1970)",
    sourceRepo: "pugazg/kalaignar-poems",
    sourcePath: "poems/kanchithan-annan",
    sourceCommit: "188d49cd4dcf2c6bbe2e9633841ff402b9959d08",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    ...
    provenanceHref: "/poems/kanchithan-annan/source",
  },
  {
    id: "kalaignarin-kaviyaranga-kavithaigal-1975",
    slug: "kalaignarin-kaviyaranga-kavithaigal-1975",
    titleTa: "கலைஞரின் கவியரங்கக் கவிதைகள்",
    titleEn: "Kalaignar's Poetry-Gathering Poems (1975)",
    shelf: "poetry",
    subtype: "poetry-publication",
    readerStructure: "poetry-publication",
    href: "/poems/kalaignarin-kaviyaranga-kavithaigal-1975",
    state: "published",
    descTa: "ஒரே பன்னூல் தொகுப்பு: மூல வரிசை எண்கள் 01 / 02 / 04 (நீக்கப்பட்ட 03 ராஜாஜி கவிதை அல்ல)",
    descEn: "One multi-item publication: source item ordinals 01 / 02 / 04 (the excluded ordinal 03 is the non-Kalaignar Rajaji poem)",
    sourceRepo: "pugazg/kalaignar-poems",
    ...
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 3, labelTa: "கவிதைகள்", labelEn: "poems" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
  ...
  {
    id: "oruthalaik-kathal",
    slug: "oruthalaik-kathal",
    titleTa: "ஒருதலைக் காதல்",
    titleEn: "One-Sided Love",
    shelf: "poetry",
    subtype: "poetry-publication",
    readerStructure: "poetry-publication",
    href: "/poems/oruthalaik-kathal",
    state: "published",
    descTa: "ஓவியக் கவிதை நாவல்: 11 மூலப் பிரிவுகள் (11 தனிக் கவிதைகள் அல்ல)",
    descEn: "A verse-novel publication: 11 source sections (not 11 independent poems)",
    sourceRepo: "pugazg/kalaignar-poems",
    sourcePath: "poems/oruthalaik-kathal",
    sourceCommit: "188d49cd4dcf2c6bbe2e9633841ff402b9959d08",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 11, labelTa: "பிரிவுகள்", labelEn: "sections" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
    ...
    provenanceHref: "/poems/oruthalaik-kathal/source",
  },
  {
    id: "periya-idathup-pen",
    slug: "periya-idathup-pen",
    titleTa: "பெரிய இடத்துப் பெண்",
    titleEn: "The Woman of the Great House",
    shelf: "fiction",
    subtype: "novel",
    readerStructure: "novel",
    href: "/novels/periya-idathup-pen",
    state: "published",
    descTa: "ஒரே தொடர்ச்சியான நாவல்: 7 காப்பக வாசிப்புப் பகுதிகள் (அச்சிடப்பட்ட அத்தியாயங்கள் அல்ல)",
    descEn: "One continuous novel in 7 archive reading sections (not printed chapters)",
    sourceRepo: "pugazg/kalaignar-novels",
    sourcePath: "works/periya-idathup-pen",
    sourceCommit: "a99f135467dd38e294faff31088a937994790a47",
    edition: "எட்டாம் பதிப்பு: ஜூலை 1953 — திராவிடன் பதிப்பகம், வேலூர் (கட்டுப்படுத்தும் மூலம்); 1978 ‘அரும்பு’ கூடுதல் கட்டுப்படுத்தாத சான்று மட்டுமே",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 7, labelTa: "பகுதிகள்", labelEn: "reading sections" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
    ...
    provenanceHref: "/novels/periya-idathup-pen/source",
  },
  {
    id: "pudhaiyal",
    slug: "pudhaiyal",
    ...
    subtype: "novel",
    readerStructure: "novel",
    href: "/novels/pudhaiyal",
    state: "published",
    descTa: "தொடர்ச்சியான நாவல்: அறிமுகம் + 51 மூல அத்தியாயங்கள் = 52 இலக்கிய அலகுகள் (இரு பக்க உடல்-இழப்புத் தகுதிப்பாட்டுடன்)",
    descEn: "A continuous novel: an Introduction + 51 source chapters = 52 literary units (with the documented two-page physical-loss qualification)",
    sourceRepo: "pugazg/kalaignar-novels",
    sourcePath: "works/pudhaiyal",
    sourceCommit: "a99f135467dd38e294faff31088a937994790a47",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 52, labelTa: "இலக்கிய அலகுகள்", labelEn: "literary units" },
    rights: {
      rightsStatus: "nationalised-by-tamil-nadu-government",
      rightsAuthority: "Government of Tamil Nadu",
      rightsAction: "nationalisation",
    ...
    provenanceHref: "/novels/pudhaiyal/source",
  },
  {
    id: "ina-muzhakkam",
    slug: "ina-muzhakkam",
    titleTa: "இன முழக்கம்",
    titleEn: "The Clarion Call of the Race",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/ina-muzhakkam",
    state: "published",
    descTa: "ஆறு கட்டுரை/கவிதை அலகுகள் கொண்ட தொகுப்பு",
    descEn: "A collection of six article/poetry units",
    sourceRepo: "pugazg/kalaignar-essays",
    ...
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 6, labelTa: "கட்டுரைகள்", labelEn: "articles" },
  ...
  },
  {
    ...
    slug: "kolaikkalam",
    titleTa: "கொலைக்களம்!",
    titleEn: "The Killing Field",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/kolaikkalam",
    state: "published",
    descTa: "ஆறு கட்டுரைத் தொகுப்பு",
    descEn: "A collection of six articles",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/kolaikkalam",
    sourceCommit: "564add708b8bd942fa9d5f505b083955248873d0",
    edition: "முதற் பதிப்பு-52 — முன்னேற்றப் பண்ணை (அச்சுச் சான்று ‘52’ மட்டுமே)",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 6, labelTa: "கட்டுரைகள்", labelEn: "articles" },
    provenanceHref: "/essays/kolaikkalam/source",
  },
  {
    id: "kudumbaththin-nalvilakku",
    slug: "kudumbaththin-nalvilakku",
    titleTa: "குடும்பத்தின் நல்விளக்கு",
    titleEn: "The Good Lamp of the Family",
    shelf: "essays-articles",
    subtype: "single-article-pamphlet",
    readerStructure: "article",
    href: "/essays/kudumbaththin-nalvilakku",
    state: "published",
    descTa: "ஒற்றைக் கட்டுரைத் துண்டுப் பிரசுரம்; பதிப்பு/ஆண்டு நிறுவப்படவில்லை",
    descEn: "A single-article pamphlet; no edition or year is established",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/kudumbaththin-nalvilakku",
    sourceCommit: "564add708b8bd942fa9d5f505b083955248873d0",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 1, labelTa: "கட்டுரை", labelEn: "article" },
    provenanceHref: "/essays/kudumbaththin-nalvilakku/source",
  },
  {
    id: "sinthanaiyum-seyalum",
    slug: "sinthanaiyum-seyalum",
    titleTa: "சிந்தனையும் செயலும்",
    titleEn: "Thought and Action",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/sinthanaiyum-seyalum",
    state: "published",
    descTa: "50 கட்டுரைத் தொகுப்பு",
    descEn: "A collection of 50 articles",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/sinthanaiyum-seyalum",
    sourceCommit: "564add708b8bd942fa9d5f505b083955248873d0",
    edition: "மூன்றாம் பதிப்பு: ஜனவரி 2010 — தமிழ்க்கனி பதிப்பகம் (ஐந்து பரிமாற்ற PDF பகுதிகள்)",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 50, labelTa: "கட்டுரைகள்", labelEn: "articles" },
    provenanceHref: "/essays/sinthanaiyum-seyalum/source",
  },
  {
    id: "vedhanai-ch-siraiyinindrum-viduthalai-pera",
    slug: "vedhanai-ch-siraiyinindrum-viduthalai-pera",
    titleTa: "வேதனைச் சிறையினின்றும் விடுதலை பெற",
    titleEn: "To Win Release from the Prison of Suffering",
    shelf: "essays-articles",
    subtype: "single-article-pamphlet",
    readerStructure: "article",
    href: "/essays/vedhanai-ch-siraiyinindrum-viduthalai-pera",
    state: "published",
    descTa: "அரசு பொதுச் ‘செய்தி’ — உரை அல்ல; தேதி/இடம் நிறுவப்படவில்லை",
    descEn: "A government public செய்தி (message), NOT a speech; no date or venue is established",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/vedhanai-ch-siraiyinindrum-viduthalai-pera",
    sourceCommit: "564add708b8bd942fa9d5f505b083955248873d0",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
  ...
  // ── Wave 7 Batches 2-4 P4 — publish 13 works (2 drama + 5 novels + 6 essays) ─────────────────────────
  // Catalogue 219→232 (Drama 8→10, Fiction 157→162, Essays 9→15; Cinema unchanged). Each reader layer is
  // DETERMINISTICALLY DERIVED from the frozen P1 source pins (stage-plays e3b2ea88, novels cc5c7fe5,
  // essays b5fd2922); see data/internal/wave7/b2-b4-p1-manifest.json. arumbu / nadutheru-narayani /
  // sarapallam-samundi are THREE SEPARATE works that merely share the 1978 அரும்பு source publication —
  // that relationship is modelled as the arumbu-1978 collection in data/collections.ts, never by collapsing
  // them into one work. nachuk-koppai is published READY-WITH-QUALIFICATION: its single terminal
  // textual-source hold (scan 22 / Scene 5) is disclosed on its public card and never reconstructed.

  // Batch 2 — Drama (readerStructure/subtype match the shelf's existing stage plays).
  {
    id: "iratha-kanneer",
    slug: "iratha-kanneer",
    titleTa: "இரத்தக் கண்ணீர்",
    titleEn: "Iratha Kanneer",
    shelf: "drama",
    subtype: "stage-play",
    readerStructure: "stage-play",
    href: "/plays/iratha-kanneer",
    state: "published",
    descTa: "மேடை நாடகம்: 61 மூல எண்ணிடப்பட்ட காட்சிகள்",
    descEn: "Stage play in 61 source-numbered scenes",
    sourceRepo: "pugazg/kalaignar-stage-plays",
    sourcePath: "works/iratha-kanneer",
    sourceCommit: "e3b2ea8879964ab8f5b6cfffad79aeab9a7ca26b",
    edition: "முதல் பதிப்பு—1953",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 61, labelTa: "காட்சிகள்", labelEn: "scenes" },
    rights: RIGHTS_NATIONALISED,
    provenanceHref: "/plays/iratha-kanneer/source",
  },
  {
    id: "nachuk-koppai",
    slug: "nachuk-koppai",
    titleTa: "நச்சுக்கோப்பை",
    titleEn: "Nachuk Koppai",
    shelf: "drama",
    subtype: "stage-play",
    readerStructure: "stage-play",
    href: "/plays/nachuk-koppai",
    state: "published",
    descTa: "மேடை நாடகம்: 18 மூல எண்ணிடப்பட்ட காட்சிகள் (ஸ்கேன் 22 / காட்சி 5-இல் ஒரு மூல எழுத்து-நிலை இடர் வெளிப்படையாகச் சுமக்கப்படுகிறது — புனையப்படவில்லை)",
    descEn: "Stage play in 18 source-numbered scenes (one terminal source textual-condition hold at scan 22 / Scene 5 is carried transparently — never reconstructed)",
    sourceRepo: "pugazg/kalaignar-stage-plays",
    sourcePath: "works/nachuk-koppai",
    sourceCommit: "e3b2ea8879964ab8f5b6cfffad79aeab9a7ca26b",
    edition: "முதற்பதிப்பு 1951",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 18, labelTa: "காட்சிகள்", labelEn: "scenes" },
    rights: RIGHTS_NATIONALISED,
    provenanceHref: "/plays/nachuk-koppai/source",
  },

  // Batch 3 — Novels. arumbu / nadutheru-narayani / sarapallam-samundi are single-section continuous
  // narratives from the shared 1978 அரும்பு publication (no standalone edition asserted on the card — the
  // edition statement lives on the arumbu-1978 collection). surulimalai and vellikkizhamai are standalone.
  {
    id: "arumbu",
    slug: "arumbu",
    titleTa: "அரும்பு",
    ...
    href: "/novels/arumbu",
    state: "published",
    descTa: "தொடர்ச்சியான புனைகதை; அரும்பு மூலத் தொகுப்பில் வெளியான மூன்று தனிப் படைப்புகளுள் ஒன்று",
    descEn: "A continuous narrative; one of three distinct works published together in the அரும்பு source compilation",
    sourceRepo: "pugazg/kalaignar-novels",
    sourcePath: "works/arumbu",
    sourceCommit: "cc5c7fe535c5fab35e87f91b8325d6801afec46c",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 1, labelTa: "படிப்புப் பகுதி", labelEn: "reading section" },
    rights: RIGHTS_NATIONALISED,
    provenanceHref: "/novels/arumbu/source",
  },
  {
    id: "nadutheru-narayani",
    slug: "nadutheru-narayani",
    titleTa: "நடுத்தெரு நாராயணி",
    titleEn: "Nadutheru Narayani",
    shelf: "fiction",
    subtype: "novel",
    readerStructure: "novel",
    href: "/novels/nadutheru-narayani",
    state: "published",
    descTa: "தொடர்ச்சியான புனைகதை; அரும்புவிலிருந்து வேறான தனிப் படைப்பு, அரும்பு மூலத் தொகுப்பைப் பகிர்கிறது",
    descEn: "A continuous narrative; a work distinct from arumbu that shares the அரும்பு source compilation",
    sourceRepo: "pugazg/kalaignar-novels",
    sourcePath: "works/nadutheru-narayani",
    sourceCommit: "cc5c7fe535c5fab35e87f91b8325d6801afec46c",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 1, labelTa: "படிப்புப் பகுதி", labelEn: "reading section" },
    rights: RIGHTS_NATIONALISED,
    provenanceHref: "/novels/nadutheru-narayani/source",
  },
  {
    id: "sarapallam-samundi",
    slug: "sarapallam-samundi",
    titleTa: "சாரப்பள்ளம் சாமுண்டி",
    titleEn: "Sarapallam Samundi",
    shelf: "fiction",
    subtype: "novel",
    readerStructure: "novel",
    href: "/novels/sarapallam-samundi",
    state: "published",
    descTa: "தொடர்ச்சியான புனைகதை; அரும்பு மூலத் தொகுப்பில் வெளியான மூன்றாவது தனிப் படைப்பு",
    descEn: "A continuous narrative; the third distinct work published in the அரும்பு source compilation",
    sourceRepo: "pugazg/kalaignar-novels",
    sourcePath: "works/sarapallam-samundi",
    sourceCommit: "cc5c7fe535c5fab35e87f91b8325d6801afec46c",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 1, labelTa: "படிப்புப் பகுதி", labelEn: "reading section" },
    rights: RIGHTS_NATIONALISED,
    provenanceHref: "/novels/sarapallam-samundi/source",
  },
  {
    id: "surulimalai",
    slug: "surulimalai",
    ...
    subtype: "novel",
    readerStructure: "novel",
    href: "/novels/surulimalai",
    state: "published",
    descTa: "நாவல்: அறிமுகம் + அச்சிட்ட அத்தியாயங்கள் = 26 படிப்புப் பிரிவுகள் (மூலத்தில் அத்தியாயம் 6, 7 அச்சிடப்படவில்லை; அந்த இடைவெளி பாதுகாக்கப்படுகிறது)",
    descEn: "A novel: an Introduction + printed chapters = 26 reading divisions (the source prints no chapters 6 or 7; that gap is preserved and never filled)",
    sourceRepo: "pugazg/kalaignar-novels",
    sourcePath: "works/surulimalai",
    sourceCommit: "cc5c7fe535c5fab35e87f91b8325d6801afec46c",
    edition: "இரண்டாம் பதிப்பு — 1968 — திராவிடப்பண்ணை",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 26, labelTa: "படிப்புப் பிரிவுகள்", labelEn: "reading divisions" },
    rights: RIGHTS_NATIONALISED,
    provenanceHref: "/novels/surulimalai/source",
  },
  {
    id: "vellikkizhamai",
    slug: "vellikkizhamai",
    titleTa: "வெள்ளிக்கிழமை",
    titleEn: "Vellikkizhamai",
    shelf: "fiction",
    subtype: "novel",
    readerStructure: "novel",
    href: "/novels/vellikkizhamai",
    state: "published",
    descTa: "நாவல்: 23 அத்தியாயங்கள்",
    descEn: "A novel in 23 chapters",
    sourceRepo: "pugazg/kalaignar-novels",
    sourcePath: "works/vellikkizhamai",
    sourceCommit: "cc5c7fe535c5fab35e87f91b8325d6801afec46c",
    edition: "இரண்டாம் பதிப்பு — 1968 — திராவிடப்பண்ணை",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 23, labelTa: "அத்தியாயங்கள்", labelEn: "chapters" },
    rights: RIGHTS_NATIONALISED,
    provenanceHref: "/novels/vellikkizhamai/source",
  },

  // Batch 4 — Essays. Following the established essay entries, no `rights` is asserted (added only on
  // evidence). Each is a source-faithful multi-article publication.
  {
    id: "aaru-maatha-kadungkaaval",
    slug: "aaru-maatha-kadungkaaval",
    titleTa: "ஆறுமாதக் கடுங்காவல்",
    titleEn: "Six Months of Rigorous Imprisonment",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/aaru-maatha-kadungkaaval",
    state: "published",
    descTa: "மூன்று கட்டுரை அலகுகள் கொண்ட தொகுப்பு",
    descEn: "A collection of three article units",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/aaru-maatha-kadungkaaval",
    sourceCommit: "b5fd2922898a56a8b6a75bf564bdfa91cd22869a",
    edition: "முதல் பதிப்பு, 1953",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 3, labelTa: "கட்டுரைகள்", labelEn: "articles" },
    provenanceHref: "/essays/aaru-maatha-kadungkaaval/source",
  },
  {
    id: "thudikkum-ilamai",
    slug: "thudikkum-ilamai",
    titleTa: "துடிக்கும் இளமை",
    titleEn: "Restless Youth",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/thudikkum-ilamai",
    state: "published",
    descTa: "நான்கு கட்டுரை அலகுகள் கொண்ட தொகுப்பு",
    descEn: "A collection of four article units",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/thudikkum-ilamai",
    sourceCommit: "b5fd2922898a56a8b6a75bf564bdfa91cd22869a",
    edition: "முதற் பதிப்பு",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 4, labelTa: "கட்டுரைகள்", labelEn: "articles" },
    provenanceHref: "/essays/thudikkum-ilamai/source",
  },
  {
    id: "perumoochu",
    slug: "perumoochu",
    titleTa: "பெருமூச்சு",
    titleEn: "The Deep Sigh",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/perumoochu",
    state: "published",
    descTa: "பதின்மூன்று கட்டுரை அலகுகள் கொண்ட தொகுப்பு",
    descEn: "A collection of thirteen article units",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/perumoochu",
    sourceCommit: "b5fd2922898a56a8b6a75bf564bdfa91cd22869a",
    edition: "முதற் பதிப்பு—'52 / இரண்டாம் பதிப்பு—'53",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 13, labelTa: "கட்டுரைகள்", labelEn: "articles" },
    provenanceHref: "/essays/perumoochu/source",
  },
  {
    id: "viduthalai-kilarcci",
    slug: "viduthalai-kilarcci",
    titleTa: "விடுதலைக் கிளர்ச்சி",
    titleEn: "The Freedom Uprising",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/viduthalai-kilarcci",
    state: "published",
    descTa: "இரண்டு கட்டுரை அலகுகள் கொண்ட தொகுப்பு",
    descEn: "A collection of two article units",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/viduthalai-kilarcci",
    sourceCommit: "b5fd2922898a56a8b6a75bf564bdfa91cd22869a",
    edition: "இரண்டாம் பதிப்பு—1953",
    tamil: "complete",
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 2, labelTa: "கட்டுரைகள்", labelEn: "articles" },
    provenanceHref: "/essays/viduthalai-kilarcci/source",
  },
  {
    id: "meesai-mulaiththa-vayathil",
    slug: "meesai-mulaiththa-vayathil",
    titleTa: "மீசை முளைத்த வயதில்",
    titleEn: "At the Age the Moustache Sprouted",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/meesai-mulaiththa-vayathil",
    state: "published",
    descTa: "இருபத்தாறு கட்டுரை அலகுகள் கொண்ட தொகுப்பு",
    descEn: "A collection of twenty-six article units",
    sourceRepo: "pugazg/kalaignar-essays",
    ...
    english: "complete",
    englishKind: "project-created",
    unitCount: { value: 26, labelTa: "கட்டுரைகள்", labelEn: "articles" },
    provenanceHref: "/essays/meesai-mulaiththa-vayathil/source",
  },
  {
    id: "pesum-kalai-valarppom",
    slug: "pesum-kalai-valarppom",
    titleTa: "பேசும் கலை வளர்ப்போம்",
    titleEn: "Let Us Cultivate the Art of Speaking",
    shelf: "essays-articles",
    subtype: "essay-collection",
    readerStructure: "article",
    href: "/essays/pesum-kalai-valarppom",
    state: "published",
    descTa: "பத்தொன்பது கட்டுரை அலகுகள் கொண்ட தொகுப்பு",
    descEn: "A collection of nineteen article units",
    sourceRepo: "pugazg/kalaignar-essays",
    sourcePath: "publications/pesum-kalai-valarppom",
    sourceCommit: "b5fd2922898a56a8b6a75bf564bdfa91cd22869a",
