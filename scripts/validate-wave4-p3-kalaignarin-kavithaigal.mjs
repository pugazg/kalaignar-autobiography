...
// Poetry top-level count is 14 (post Wave-6 P4: 6 + eight Batch-4 poetry works); collections still 1.
{
  ...
  // excluding recognized later declarations rather than tracking a literal; this publication never a collection.
  ...
  check("the Kalaignarin Kavithaigal publication did not become a LibraryCollection", !inlineCollectionIds.includes(SLUG));
