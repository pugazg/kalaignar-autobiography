...
eq(works.length, 232 + W7K.works + W8.works, "A5 published works = 333 (post Wave-7 B1: +3 cinema; post Wave-7 B2-B4: +13; post Wave-7 B5/B6/K: +101)");
...
eq(sortedCensus(byShelf), sortedCensus({
  "life-writing": 1, letters: 1, fiction: 162, poetry: 14, drama: 10 + W8.drama,
  "cinema-writing": 10, speeches: 17 + W7K.speeches, "essays-articles": 15, "literary-commentary": 2 + W7K.literaryCommentary + W8.literaryCommentary,
